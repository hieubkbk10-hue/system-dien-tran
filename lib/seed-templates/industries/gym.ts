...
export const industryTemplate: IndustryTemplate = {
  ...
  "assets": {
    "hero": [
      "/seed_mau/gym/hero/hero-1.jpg",
      "/seed_mau/gym/hero/hero-2.jpg"
    ],
    "products": [
      "/seed_mau/gym/products/product-1.jpg",
      "/seed_mau/gym/products/product-2.jpg",
      "/seed_mau/gym/products/product-3.jpg",
      "/seed_mau/gym/products/product-4.jpg"
    ],
    "posts": [
      "/seed_mau/gym/posts/post-1.jpg",
      "/seed_mau/gym/posts/post-2.jpg",
      "/seed_mau/gym/posts/post-3.jpg"
    ],
    "logos": [
      "/seed_mau/gym/logos/logo-1.png",
      "/seed_mau/gym/logos/logo-2.png",
      "/seed_mau/gym/logos/logo-3.png"
    ],
    "gallery": [
      "/seed_mau/gym/gallery/gallery-1.jpg",
      "/seed_mau/gym/gallery/gallery-2.jpg",
      "/seed_mau/gym/gallery/gallery-3.jpg",
      "/seed_mau/gym/gallery/gallery-4.jpg"
    ]
  },
  "fakerTemplates": {
    "namePatterns": [
  ...
  "homeComponents": [
    {
      ...
      "config": {
        ...
        "slides": [
          {
            "image": "/seed_mau/gym/hero/hero-1.jpg",
            "link": "/products"
          },
          {
            "image": "/seed_mau/gym/hero/hero-2.jpg",
            "link": "/products"
          }
        ],
        "content": {
    ...
    },
    {
      ...
      "config": {
        ...
        "image": "/seed_mau/gym/gallery/gallery-1.jpg"
      }
    },
    {
      "type": "CTA",
