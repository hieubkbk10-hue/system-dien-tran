...
export const industryTemplate: IndustryTemplate = {
  ...
  "assets": {
    "hero": [
      "/seed_mau/yoga/hero/hero-1.webp",
      "/seed_mau/yoga/hero/hero-2.webp"
    ],
    "products": [
      "/seed_mau/yoga/products/product-1.webp",
      "/seed_mau/yoga/products/product-2.webp",
      "/seed_mau/yoga/products/product-3.webp",
      "/seed_mau/yoga/products/product-4.webp"
    ],
    "posts": [
      "/seed_mau/yoga/posts/post-1.webp",
      "/seed_mau/yoga/posts/post-2.webp",
    ...
    "gallery": [
      ...
      "/seed_mau/yoga/gallery/gallery-2.webp",
      "/seed_mau/yoga/gallery/gallery-3.webp",
      "/seed_mau/yoga/gallery/gallery-4.webp"
    ]
  },
  "fakerTemplates": {
    "namePatterns": [
  ...
  "homeComponents": [
    {
      ...
      "config": {
        ...
        "slides": [
          {
            "image": "/seed_mau/yoga/hero/hero-1.webp",
            "link": "/products"
          },
          {
            "image": "/seed_mau/yoga/hero/hero-2.webp",
            "link": "/products"
          }
        ],
        "content": {
    ...
    },
    {
      ...
      "config": {
        ...
        "image": "/seed_mau/yoga/gallery/gallery-1.webp"
      }
    },
    {
      "type": "CTA",
