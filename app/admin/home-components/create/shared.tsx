...
export const COMPONENT_TYPES = [
  ...
  { description: 'Logo đối tác, khách hàng', icon: Users, label: 'Đối tác / Logos', route: 'partners', value: 'Partners', position: 3 },
  { description: 'Giải thưởng, chứng chỉ', icon: Award, label: 'Chứng nhận', route: 'trust-badges', value: 'TrustBadges', position: 4 },
  ...
  { description: 'Sản phẩm theo danh mục', icon: Package, label: 'Danh sách Sản phẩm', route: 'product-list', value: 'ProductList', recommended: true, position: 6 },
  ...
  { description: 'Các dịch vụ cung cấp', icon: Briefcase, label: 'Danh sách Dịch vụ', route: 'service-list', value: 'ServiceList', position: 8 },
  { description: 'Bài viết mới nhất', icon: FileText, label: 'Tin tức / Blog', route: 'blog', value: 'Blog', position: 9 },
  ...
  { description: 'Hình ảnh hoạt động', icon: ImageIcon, label: 'Thư viện ảnh', route: 'gallery', value: 'Gallery', position: 16 },
