...
export function ProductListCreateShared({ type, titleLabel }: ProductListCreateSharedProps) {
  ...
  const { customState, effectiveColors, showCustomBlock, setCustomState, systemColors, isCreateCustomLocked } = useTypeColorOverrideState(colorOverrideType, { lockCustomUntilTypeHasData: true });
