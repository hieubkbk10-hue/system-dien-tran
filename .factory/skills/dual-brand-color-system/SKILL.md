...
description: Best practices cho dual brand color systems trong UI/UX dựa trên Material Design 3, 60-30-10 rule, và WCAG accessibility. Dùng khi thiết kế/review hệ thống màu thương hiệu (primary + secondary), chọn color harmony schemes, validate contrast ratios, hoặc cải thiện color palette cho brand identity.
version: 1.0.0
---

# Dual Brand Color System Best Practices
...
- WCAG 2.1: contrast ratios và accessibility
